...
<html lang="pt-br">
       <head>
            ...
            <meta charset="utf-8">
            <meta name="description" content="descrição legal da minha pagina">
            <meta name="author" content="Andre santana">
      ...
      <body>
       <h1>André santana </h1>
     <p class="center subtitle">Brasileiro, solteiro, 22 anos.</p>

    <ul class="menu">
        <li><a href="https://www.linkedin.com/in/andr%C3%A9-santana-4095b51b0/">Linkedin</a></li>
        <li><a href="https://github.com/andresantana165">Github</a></li>
